 ...
 */
const We = window, qi = We.ShadowRoot && (We.ShadyCSS === void 0 || We.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, ji = Symbol(), co = /* @__PURE__ */ new WeakMap();
let Ao = class {
  constructor(r, s, h) {
    if (this._$cssResult$ = !0, h !== ji)
  ...
  get styleSheet() {
    ...
    if (qi && r === void 0) {
      ...
      h && (r = co.get(s)), r === void 0 && ((this.o = r = new CSSStyleSheet()).replaceSync(this.cssText), h && co.set(s, r));
    }
    return r;
  }
  toString() {
...
const ls = (l) => new Ao(typeof l == "string" ? l : l + "", void 0, ji), Tt = (l, ...r) => {
  ...
  return new Ao(s, l, ji);
}, hs = (l, r) => {
  qi ? l.adoptedStyleSheets = r.map((s) => s instanceof CSSStyleSheet ? s : s.styleSheet) : r.forEach((s) => {
    const h = document.createElement("style"), u = We.litNonce;
    u !== void 0 && h.setAttribute("nonce", u), h.textContent = s.cssText, l.appendChild(h);
  });
}, fo = qi ? (l) => l : (l) => l instanceof CSSStyleSheet ? ((r) => {
  let s = "";
 ...
 */
var Bi;
const Ue = window, po = Ue.trustedTypes, us = po ? po.emptyScript : "", _o = Ue.reactiveElementPolyfillSupport, Ui = { toAttribute(l, r) {
  switch (r) {
    case Boolean:
      l = l ? us : null;
      break;
  ...
  return s;
} }, Co = (l, r) => r !== l && (r == r || l == l), Ri = { attribute: !0, type: String, converter: Ui, reflect: !1, hasChanged: Co };
let Ut = class extends HTMLElement {
  ...
  static getPropertyOptions(r) {
    return this.elementProperties.get(r) || Ri;
  }
  static finalize() {
  ...
  _$EO(r, s, h = Ri) {
    ...
    if (_ !== void 0 && h.reflect === !0) {
      const p = (((u = h.converter) === null || u === void 0 ? void 0 : u.toAttribute) !== void 0 ? h.converter : Ui).toAttribute(s, h.type);
  ...
  _$AK(r, s) {
    ...
    if (_ !== void 0 && this._$El !== _) {
      const p = u.getPropertyOptions(_), B = typeof p.converter == "function" ? { fromAttribute: p.converter } : ((h = p.converter) === null || h === void 0 ? void 0 : h.fromAttribute) !== void 0 ? p.converter : Ui;
...
Ut.finalized = !0, Ut.elementProperties = /* @__PURE__ */ new Map(), Ut.elementStyles = [], Ut.shadowRootOptions = { mode: "open" }, _o == null || _o({ ReactiveElement: Ut }), ((Bi = Ue.reactiveElementVersions) !== null && Bi !== void 0 ? Bi : Ue.reactiveElementVersions = []).push("1.6.1");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
var $i;
const Fe = window, Vt = Fe.trustedTypes, mo = Vt ? Vt.createPolicy("lit-html", { createHTML: (l) => l }) : void 0, Lt = `lit$${(Math.random() + "").slice(9)}$`, Eo = "?" + Lt, cs = `<${Eo}>`, qt = document, ge = (l = "") => qt.createComment(l), ve = (l) => l === null || typeof l != "object" && typeof l != "function", So = Array.isArray, ds = (l) => So(l) || typeof (l == null ? void 0 : l[Symbol.iterator]) == "function", pe = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, go = /-->/g, vo = />/g, zt = RegExp(`>|[ 	
\f\r](?:([^\\s"'>=/]+)([ 	
\f\r]*=[ 	
\f\r]*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), yo = /'/g, bo = /"/g, Mo = /^(?:script|style|textarea|title)$/i, fs = (l) => (r, ...s) => ({ _$litType$: l, strings: r, values: s }), st = fs(1), jt = Symbol.for("lit-noChange"), N = Symbol.for("lit-nothing"), wo = /* @__PURE__ */ new WeakMap(), Ft = qt.createTreeWalker(qt, 129, null, !1), ps = (l, r) => {
  ...
  for (let v = 0; v < s; v++) {
    ...
    for (; j < C.length && (p.lastIndex = j, b = p.exec(C), b !== null); )
      j = p.lastIndex, p === pe ? b[1] === "!--" ? p = go : b[1] !== void 0 ? p = vo : b[2] !== void 0 ? (Mo.test(b[2]) && (u = RegExp("</" + b[2], "g")), p = zt) : b[3] !== void 0 && (p = zt) : p === zt ? b[0] === ">" ? (p = u ?? pe, k = -1) : b[1] === void 0 ? k = -2 : (k = p.lastIndex - b[2].length, q = b[1], p = b[3] === void 0 ? zt : b[3] === '"' ? bo : yo) : p === bo || p === yo ? p = zt : p === go || p === vo ? p = pe : (p = zt, u = void 0);
    const Q = p === zt && l[v + 1].startsWith("/>") ? " " : "";
    _ += p === pe ? C + cs : k >= 0 ? (h.push(q), C.slice(0, k) + "$lit$" + C.slice(k) + Lt + Q) : C + Lt + (k === -2 ? (h.push(void 0), v) : Q);
  }
  const B = _ + (l[s] || "<?>") + (r === 2 ? "</svg>" : "");
  if (!Array.isArray(l) || !l.hasOwnProperty("raw"))
    throw Error("invalid template strings array");
  return [mo !== void 0 ? mo.createHTML(B) : B, h];
};
class ye {
  constructor({ strings: r, _$litType$: s }, h) {
    ...
    if (this.el = ye.createElement(C, h), Ft.currentNode = this.el.content, s === 2) {
      ...
      if (u.nodeType === 1) {
        if (u.hasAttributes()) {
          ...
          for (const k of u.getAttributeNames())
            if (k.endsWith("$lit$") || k.startsWith(Lt)) {
              const j = q[p++];
              if (b.push(k), j !== void 0) {
                const Q = u.getAttribute(j.toLowerCase() + "$lit$").split(Lt), z = /([.?@])?(.*)/.exec(j);
                v.push({ type: 1, index: _, name: z[2], strings: Q, ctor: z[1] === "." ? ms : z[1] === "?" ? vs : z[1] === "@" ? ys : Ge });
              } else
        ...
        if (Mo.test(u.tagName)) {
          const b = u.textContent.split(Lt), k = b.length - 1;
          if (k > 0) {
            u.textContent = Vt ? Vt.emptyScript : "";
            for (let j = 0; j < k; j++)
              u.append(b[j], ge()), Ft.nextNode(), v.push({ type: 2, index: ++_ });
            u.append(b[k], ge());
          }
        }
        ...
        if (u.data === Eo)
          ...
          let b = -1;
          for (; (b = u.data.indexOf(Lt, b + 1)) !== -1; )
            v.push({ type: 7, index: _ }), b += Lt.length - 1;
        }
      _++;
    }
  }
...
function Gt(l, r, s = l, h) {
  ...
  const C = ve(r) ? void 0 : r._$litDirective$;
...
class _s {
  ...
  v(r) {
    ...
    for (; C !== void 0; ) {
      if (B === C.index) {
        let q;
        C.type === 2 ? q = new be(p, p.nextSibling, this, r) : C.type === 1 ? q = new C.ctor(p, C.name, C.strings, this, r) : C.type === 6 && (q = new bs(p, this, r)), this.u.push(q), C = u[++v];
      }
...
class be {
  ...
  _$AI(r, s = this) {
    r = Gt(this, r, s), ve(r) ? r === N || r == null || r === "" ? (this._$AH !== N && this._$AR(), this._$AH = N) : r !== this._$AH && r !== jt && this.g(r) : r._$litType$ !== void 0 ? this.$(r) : r.nodeType !== void 0 ? this.T(r) : ds(r) ? this.k(r) : this.g(r);
  }
  O(r, s = this._$AB) {
  ...
  g(r) {
    this._$AH !== N && ve(this._$AH) ? this._$AA.nextSibling.data = r : this.T(qt.createTextNode(r)), this._$AH = r;
  }
  $(r) {
    var s;
    const { values: h, _$litType$: u } = r, _ = typeof u == "number" ? this._$AC(r) : (u.el === void 0 && (u.el = ye.createElement(u.h, this.options)), u);
  ...
  _$AC(r) {
    let s = wo.get(r.strings);
    return s === void 0 && wo.set(r.strings, s = new ye(r)), s;
  }
  k(r) {
    ...
    let h, u = 0;
    for (const _ of r)
      u === s.length ? s.push(h = new be(this.O(ge()), this.O(ge()), this, this.options)) : h = s[u], h._$AI(_), u++;
...
class Ge {
  ...
  _$AI(r, s = this, h, u) {
    ...
    let p = !1;
    if (_ === void 0)
      r = Gt(this, r, s, 0), p = !ve(r) || r !== this._$AH && r !== jt, p && (this._$AH = r);
    else {
      const B = r;
      let v, C;
      for (r = _[0], v = 0; v < _.length - 1; v++)
        C = Gt(this, B[h + v], s, v), C === jt && (C = this._$AH[v]), p || (p = !ve(C) || C !== this._$AH[v]), C === N ? r = N : r !== N && (r += (C ?? "") + _[v + 1]), this._$AH[v] = C;
    }
    p && !u && this.j(r);
  }
  j(r) {
...
const xo = Fe.litHtmlPolyfillSupport;
xo == null || xo(ye, be), (($i = Fe.litHtmlVersions) !== null && $i !== void 0 ? $i : Fe.litHtmlVersions = []).push("2.6.1");
const ws = (l, r, s) => {
  var h, u;
  ...
  if (p === void 0) {
    ...
    _._$litPart$ = p = new be(r.insertBefore(ge(), B), B, void 0, s ?? {});
  }
  return p._$AI(l), p;
};
/**
...
at.finalized = !0, at._$litElement$ = !0, (Di = globalThis.litElementHydrateSupport) === null || Di === void 0 || Di.call(globalThis, { LitElement: at });
const Po = globalThis.litElementPolyfillSupport;
Po == null || Po({ LitElement: at });
((Ni = globalThis.litElementVersions) !== null && Ni !== void 0 ? Ni : globalThis.litElementVersions = []).push("3.2.2");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 */
var Hi;
((Hi = window.HTMLSlotElement) === null || Hi === void 0 ? void 0 : Hi.prototype.assignedElements) != null;
/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Ps = (l) => l.strings === void 0;
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Ls = { ATTRIBUTE: 1, CHILD: 2, PROPERTY: 3, BOOLEAN_ATTRIBUTE: 4, EVENT: 5, ELEMENT: 6 }, Ts = (l) => (...r) => ({ _$litDirective$: l, values: r });
class As {
  constructor(r) {
  }
  get _$AU() {
...
const me = (l, r) => {
  ...
  if (u === void 0)
    return !1;
  for (const _ of u)
    (h = (s = _)._$AO) === null || h === void 0 || h.call(s, r, !1), me(_, r);
  return !0;
}, Ve = (l) => {
  let r, s;
  do {
...
function Cs(l) {
  this._$AN !== void 0 ? (Ve(this), this._$AM = l, zo(this)) : this._$AM = l;
}
function Es(l, r = !1, s = 0) {
...
const Ss = (l) => {
  var r, s, h, u;
  l.type == Ls.CHILD && ((r = (h = l)._$AP) !== null && r !== void 0 || (h._$AP = Es), (s = (u = l)._$AQ) !== null && s !== void 0 || (u._$AQ = Cs));
};
class Ms extends As {
  constructor() {
  ...
  _$AT(r, s, h) {
    super._$AT(r, s, h), zo(this), this.isConnected = r._$AU;
  }
  _$AO(r, s = !0) {
    var h, u;
    r !== this.isConnected && (this.isConnected = r, r ? (h = this.reconnected) === null || h === void 0 || h.call(this) : (u = this.disconnected) === null || u === void 0 || u.call(this)), s && (me(this, r), Ve(this));
  }
  setValue(r) {
    if (Ps(this._$Ct))
...
const Wi = /* @__PURE__ */ new WeakMap(), To = Ts(class extends Ms {
  render(l) {
    return N;
  }
  update(l, [r]) {
  ...
  rt(l) {
    ...
    if (typeof this.Y == "function") {
      ...
      let h = Wi.get(s);
      h === void 0 && (h = /* @__PURE__ */ new WeakMap(), Wi.set(s, h)), h.get(this.Y) !== void 0 && this.Y.call(this.dt, void 0), h.set(this.Y, l), l !== void 0 && this.Y.call(this.dt, l);
    } else
      this.Y.value = l;
  }
  get lt() {
    var l, r, s;
    return typeof this.Y == "function" ? (r = Wi.get((l = this.dt) !== null && l !== void 0 ? l : globalThis)) === null || r === void 0 ? void 0 : r.get(this.Y) : (s = this.Y) === null || s === void 0 ? void 0 : s.value;
  }
  disconnected() {
...
var zs = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, vt = {}, Os = {
  get exports() {
    return vt;
  },
  set exports(l) {
...
(function(l, r) {
  (function(s, h) {
    ...
    var we = "data:image/gif;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs=";
    function ti(t) {
      return window["webkit" + t] || window["moz" + t] || window["ms" + t];
    }
    var Ki = 0;
    function Ji(t) {
      var e = +new Date(), i = Math.max(0, 16 - (e - Ki));
      return Ki = e + i, window.setTimeout(t, i);
    }
    var ei = window.requestAnimationFrame || ti("RequestAnimationFrame") || Ji, Qi = window.cancelAnimationFrame || ti("CancelAnimationFrame") || ti("CancelRequestAnimationFrame") || function(t) {
    ...
    P.prototype = {
      ...
      _trunc: function() {
        return this.x = Xi(this.x), this.y = Xi(this.y), this;
      },
    ...
    function te(t, e, i, n) {
      return new ni(t, e, i, n);
    }
    var oi = u({}, bt, {
      code: "EPSG:3857",
      projection: ii,
      transformation: function() {
        var t = 0.5 / (Math.PI * ii.R);
    ...
    var ri = document.documentElement.style, xe = "ActiveXObject" in window, Do = xe && !document.addEventListener, on = "msLaunchUri" in navigator && !("documentMode" in document), si = lt("webkit"), rn = lt("android"), sn = lt("android 2") || lt("android 3"), No = parseInt(/WebKit\/([0-9]+)|$/.exec(navigator.userAgent)[1], 10), Ho = rn && lt("Google") && No < 537 && !("AudioNode" in window), ai = !!window.opera, an = !on && lt("chrome"), ln = lt("gecko") && !si && !ai && !xe, Wo = !an && lt("safari"), hn = lt("phantom"), un = "OTransition" in ri, Uo = navigator.platform.indexOf("Win") === 0, cn = xe && "transition" in ri, li = "WebKitCSSMatrix" in window && "m11" in new window.WebKitCSSMatrix() && !sn, dn = "MozPerspective" in ri, Fo = !window.L_DISABLE_3D && (cn || li || dn) && !un && !hn, ee = typeof orientation < "u" || lt("mobile"), Vo = ee && si, qo = ee && li, fn = !window.PointerEvent && window.MSPointerEvent, pn = !!(window.PointerEvent || fn), _n = "ontouchstart" in window || !!window.TouchEvent, jo = !window.L_NO_TOUCH && (_n || pn), Go = ee && ai, Yo = ee && ln, Ko = (window.devicePixelRatio || window.screen.deviceXDPI / window.screen.logicalXDPI) > 1, Jo = function() {
      var t = !1;
      try {
    ...
    }(), hi = !!(document.createElementNS && en("svg").createSVGRect), Xo = !!hi && function() {
    ...
    var y = {
      ...
      mac: er,
      linux: ir
    }, mn = y.msPointer ? "MSPointerDown" : "pointerdown", gn = y.msPointer ? "MSPointerMove" : "pointermove", vn = y.msPointer ? "MSPointerUp" : "pointerup", yn = y.msPointer ? "MSPointerCancel" : "pointercancel", ui = {
      touchstart: mn,
      touchmove: gn,
      touchend: vn,
      touchcancel: yn
    ...
    function nr(t, e, i) {
      return e === "touchstart" && ar(), bn[e] ? (i = bn[e].bind(this, i), t.addEventListener(ui[e], i, !1), i) : (console.warn("wrong event specified:", e), b);
    }
    function or(t, e, i) {
      if (!ui[e]) {
    ...
    function ar() {
      wn || (document.addEventListener(mn, rr, !0), document.addEventListener(gn, sr, !0), document.addEventListener(vn, xn, !0), document.addEventListener(yn, xn, !0), wn = !0);
    }
    function Pe(t, e) {
    ...
    function lr(t, e) {
      e.MSPOINTER_TYPE_TOUCH && e.pointerType === e.MSPOINTER_TYPE_TOUCH && V(e), Pe(t, e);
    }
    function hr(t) {
      var e = {}, i, n;
      for (n in t)
    ...
    ), Pn = ie === "webkitTransition" || ie === "OTransition" ? ie + "End" : "transitionend";
    function Ln(t) {
    ...
    function D(t, e) {
      t.classList !== void 0 ? t.classList.remove(e) : fi(t, j((" " + Te(t) + " ").replace(" " + e + " ", " ")));
    }
    function fi(t, e) {
    ...
    function At(t, e, i) {
      var n = e || new P(0, 0);
      t.style[ci] = (y.ie3d ? "translate(" + n.x + "px," + n.y + "px)" : "translate3d(" + n.x + "px," + n.y + "px,0)") + (i ? " scale(" + i + ")" : "");
    }
    function H(t, e) {
      t._leaflet_pos = e, y.any3d ? At(t, e) : (t.style.left = e.x + "px", t.style.top = e.y + "px");
    }
    function Ct(t) {
    ...
    if ("onselectstart" in document)
      ...
      oe = function() {
        ...
        se && (document.documentElement.style[se] = pi, pi = void 0);
      };
    }
    function _i() {
    ...
    function vi(t) {
      for (; t.tabIndex === -1; )
        t = t.parentNode;
      t.style && (Ee(), Ce = t, gi = t.style.outline, t.style.outline = "none", T(window, "keydown", Ee));
    }
    function Ee() {
      Ce && (Ce.style.outline = gi, Ce = void 0, gi = void 0, Z(window, "keydown", Ee));
    }
    function Tn(t) {
      do
        t = t.parentNode;
    ...
    function wi(t, e, i, n) {
      ...
      !y.touchNative && y.pointer && e.indexOf("touch") === 0 ? a = nr(t, e, a) : y.touch && e === "dblclick" ? a = cr(t, a) : "addEventListener" in t ? e === "touchstart" || e === "touchmove" || e === "wheel" || e === "mousewheel" ? t.addEventListener(bi[e] || e, a, y.passiveEvents ? { passive: !1 } : !1) : e === "mouseenter" || e === "mouseleave" ? (a = function(d) {
        d = d || window.event, Li(t, d) && c(d);
      }, t.addEventListener(bi[e], a, !1)) : t.addEventListener(e, c, !1) : t.attachEvent("on" + e, a), t[ht] = t[ht] || {}, t[ht][o] = a;
    }
    function xi(t, e, i, n, o) {
      ...
      if (!a)
        return this;
      !y.touchNative && y.pointer && e.indexOf("touch") === 0 ? or(t, e, a) : y.touch && e === "dblclick" ? dr(t, a) : "removeEventListener" in t ? t.removeEventListener(bi[e] || e, a, !1) : t.detachEvent("on" + e, a), t[ht][o] = null;
    }
    function Et(t) {
      return t.stopPropagation ? t.stopPropagation() : t.originalEvent ? t.originalEvent._stopped = !0 : t.cancelBubble = !0, this;
    }
    function Pi(t) {
      return wi(t, "wheel", Et), this;
    }
    function ae(t) {
      return T(t, "mousedown touchstart dblclick contextmenu", Et), t._leaflet_disable_click = !0, this;
    }
    function V(t) {
      return t.preventDefault ? t.preventDefault() : t.returnValue = !1, this;
    }
    function St(t) {
      return V(t), Et(t), this;
    }
    function Cn(t) {
      if (t.composedPath)
    ...
    function En(t, e) {
      ...
      var i = yi(e), n = i.boundingClientRect;
      return new P(
    ...
    var mr = {
      ...
      run: function(t, e, i, n) {
        this.stop(), this._el = t, this._inProgress = !0, this._duration = i || 0.25, this._easeOutPower = 1 / Math.max(n || 0.5, 0.2), this._startPos = Ct(t), this._offset = e.subtract(this._startPos), this._startTime = +new Date(), this.fire("start"), this._animate();
      },
      // @method stop()
      ...
      flyTo: function(t, e, i) {
        ...
        function E(W) {
          var He = W ? -1 : 1, os = W ? f : d, rs = f * f - d * d + He * w * w * m * m, ss = 2 * os * w * m, Zi = rs / ss, uo = Math.sqrt(Zi * Zi + 1) - Zi, as = uo < 1e-9 ? -18 : Math.log(uo);
          return as;
        }
        function it(W) {
        ...
        var Pt = E(0);
        function Ii(W) {
          return d * (kt(Pt) / kt(Pt + g * W));
        }
        function ts(W) {
          return d * (kt(Pt) * Ne(Pt + g * W) - it(Pt)) / w;
        }
        function es(W) {
          return 1 - Math.pow(1 - W, 1.5);
        }
        var is = Date.now(), lo = (E(1) - Pt) / g, ns = i.duration ? 1e3 * i.duration : 1e3 * lo * 0.8;
        function ho() {
          var W = (Date.now() - is) / ns, He = es(W) * lo;
          W <= 1 ? (this._flyToFrame = G(ho, this), this._move(
            this.unproject(n.add(o.subtract(n).multiplyBy(ts(He) / m)), c),
            this.getScaleZoom(d / Ii(He), c),
            { flyTo: !0 }
          )) : this._move(t, e)._moveEnd(!0);
        }
        return this._moveStart(!0, i.noMoveStart), ho.call(this), this;
      },
      ...
      remove: function() {
        ...
        this._locationWatchId !== void 0 && this.stopLocate(), this._stop(), $(this._mapPane), this._clearControlPos && this._clearControlPos(), this._resizeRequest && (X(this._resizeRequest), this._resizeRequest = null), this._clearHandlers(), this._loaded && this.fire("unload");
        var t;
      ...
      createPane: function(t, e) {
        var i = "leaflet-pane" + (t ? " leaflet-" + t.replace("Pane", "") + "-pane" : ""), n = M("div", i, e || this._mapPane);
      ...
      _findEventTargets: function(t, e) {
        for (var i = [], n, o = e === "mouseout" || e === "mouseover", a = t.target || t.srcElement, c = !1; a; ) {
          ...
          if (n && n.listens(e, !0) && (o && !Li(a, t) || (i.push(n), o)) || a === this._container)
            break;
          a = a.parentNode;
        }
      ...
      _handleDOMEvent: function(t) {
        ...
        if (!(!this._loaded || e._leaflet_disable_events || t.type === "click" && this._isClickDisabled(e))) {
          var i = t.type;
          i === "mousedown" && vi(e), this._fireDOMEvent(t, i);
        }
      },
      ...
      _fireDOMEvent: function(t, e, i) {
        ...
        if (o.length) {
          ...
          for (c = 0; c < o.length; c++)
            if (o[c].fire(e, f, !0), f.originalEvent._stopped || o[c].options.bubblingMouseEvents === !1 && Xe(this._mouseEvents, e) !== -1)
              return;
        }
      },
      ...
      _getMapPanePos: function() {
        return Ct(this._mapPane) || new P(0, 0);
      },
      _moved: function() {
        var t = this._getMapPanePos();
      ...
      _onPanTransitionEnd: function() {
        D(this._mapPane, "leaflet-pan-anim"), this.fire("moveend");
      },
      ...
      _createAnimProxy: function() {
        var t = this._proxy = M("div", "leaflet-proxy leaflet-zoom-animated");
      ...
      _destroyAnimProxy: function() {
        $(this._proxy), this.off("load moveend", this._animMoveEnd, this), delete this._proxy;
      },
      ...
      _onZoomTransitionEnd: function() {
        this._animatingZoom && (this._mapPane && D(this._mapPane, "leaflet-zoom-anim"), this._animatingZoom = !1, this._move(this._animateToCenter, this._animateToZoom, void 0, !0), this._tempFireZoomEvent && this.fire("zoom"), delete this._tempFireZoomEvent, this.fire("move"), this._moveEnd(!0));
      }
    });
    function gr(t, e) {
      return new S(t, e);
    ...
    var ot = dt.extend({
      ...
      remove: function() {
        return this._map ? ($(this._container), this.onRemove && this.onRemove(this._map), this._map.off("unload", this.remove, this), this._map = null, this) : this;
      },
    ...
    S.include({
      ...
      _initControlPos: function() {
        var t = this._controlCorners = {}, e = "leaflet-", i = this._controlContainer = M("div", e + "control-container", this._container);
        function n(o, a) {
          var c = e + o + " " + e + a;
          t[o + a] = M("div", c, i);
        }
    ...
    var kn = ot.extend({
      ...
      expand: function() {
        ...
        return t < this._section.clientHeight ? (A(this._section, "leaflet-control-layers-scrollbar"), this._section.style.height = t + "px") : D(this._section, "leaflet-control-layers-scrollbar"), this._checkDisabledLayers(), this;
      },
      // @method collapse(): this
      // Collapse the control container if expanded.
      collapse: function() {
        return D(this._container, "leaflet-control-layers-expanded"), this;
      },
      _initLayout: function() {
        var t = "leaflet-control-layers", e = this._container = M("div", t), i = this.options.collapsed;
        e.setAttribute("aria-haspopup", !0), ae(e), Pi(e);
        var n = this._section = M("section", t + "-list");
        i && (this._map.on("click", this.collapse, this), T(e, {
          mouseenter: this._expandSafely,
          mouseleave: this.collapse
        }, this));
        var o = this._layersLink = M("a", t + "-toggle", e);
        ...
        }, this), i || this.expand(), this._baseLayersList = M("div", t + "-base", n), this._separator = M("div", t + "-separator", n), this._overlaysList = M("div", t + "-overlays", n), e.appendChild(n);
      },
      ...
      onAdd: function(t) {
        var e = "leaflet-control-zoom", i = M("div", e + " leaflet-bar"), n = this.options;
      ...
      _createButton: function(t, e, i, n, o) {
        var a = M("a", i, n);
        return a.innerHTML = t, a.href = "#", a.title = e, a.setAttribute("role", "button"), a.setAttribute("aria-label", e), ae(a), T(a, "click", St), T(a, "click", o, this), T(a, "click", this._refocusOnMap, this), a;
      },
      _updateDisabled: function() {
        var t = this._map, e = "leaflet-disabled";
        D(this._zoomInButton, e), D(this._zoomOutButton, e), this._zoomInButton.setAttribute("aria-disabled", "false"), this._zoomOutButton.setAttribute("aria-disabled", "false"), (this._disabled || t._zoom === t.getMinZoom()) && (A(this._zoomOutButton, e), this._zoomOutButton.setAttribute("aria-disabled", "true")), (this._disabled || t._zoom === t.getMaxZoom()) && (A(this._zoomInButton, e), this._zoomInButton.setAttribute("aria-disabled", "true"));
      }
    });
    S.mergeOptions({
      zoomControl: !0
    ...
    var yr = function(t) {
      ...
      onAdd: function(t) {
        var e = "leaflet-control-scale", i = M("div", e), n = this.options;
      ...
      _addScales: function(t, e, i) {
        t.metric && (this._mScale = M("div", e, i)), t.imperial && (this._iScale = M("div", e, i));
      },
      _update: function() {
      ...
      return new zn(t);
    }, wr = '<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="12" height="8" viewBox="0 0 12 8" class="leaflet-attribution-flag"><path fill="#4C7BE1" d="M0 0h12v4H0z"/><path fill="#FFD500" d="M0 4h12v3H0z"/><path fill="#E0BC00" d="M0 7h12v1H0z"/></svg>', Ai = ot.extend({
      // @section
      ...
      onAdd: function(t) {
        t.attributionControl = this, this._container = M("div", "leaflet-control-attribution"), ae(this._container);
    ...
    ot.Layers = kn, ot.Zoom = Ti, ot.Scale = zn, ot.Attribution = Ai, le.layers = vr, le.zoom = yr, le.scale = br, le.attribution = xr;
    var ut = dt.extend({
      initialize: function(t) {
        this._map = t;
      },
    ...
    var Pr = { Events: J }, On = y.touch ? "touchstart mousedown" : "mousedown", wt = Xt.extend({
      options: {
        // @section
      ...
      enable: function() {
        this._enabled || (T(this._dragStartTarget, On, this._onDown, this), this._enabled = !0);
      },
      // @method disable()
      // Disables the dragging ability
      disable: function() {
        this._enabled && (wt._dragging === this && this.finishDrag(!0), Z(this._dragStartTarget, On, this._onDown, this), this._enabled = !1, this._moved = !1);
      },
      _onDown: function(t) {
        if (this._enabled && (this._moved = !1, !di(this._element, "leaflet-zoom-anim"))) {
          ...
          if (!(wt._dragging || t.shiftKey || t.which !== 1 && t.button !== 1 && !t.touches) && (wt._dragging = this, this._preventOutline && vi(this._element), _i(), oe(), !this._moving)) {
            this.fire("down");
            var e = t.touches ? t.touches[0] : t, i = Tn(this._element);
            this._startPoint = new P(e.clientX, e.clientY), this._startPos = Ct(this._element), this._parentScale = yi(i);
      ...
      finishDrag: function(t) {
        D(document.body, "leaflet-dragging"), this._lastTarget && (D(this._lastTarget, "leaflet-drag-target"), this._lastTarget = null), Z(document, "mousemove touchmove", this._onMove, this), Z(document, "mouseup touchend touchcancel", this._onUp, this), mi(), re(), this._moved && this._moving && this.fire("dragend", {
          noInertia: t,
    ...
    function Ci(t, e, i, n, o) {
      ...
      a > i && (e[c] = 1, Ci(t, e, i, n, c), Ci(t, e, i, c, o));
    }
    function Ar(t, e) {
    ...
    function Rn(t, e, i, n, o) {
      var a = n ? Bn : Mt(t, i), c = Mt(e, i), d, f, m;
      for (Bn = c; ; ) {
        if (!(a | c))
          return [t, e];
        if (a & c)
          return !1;
        d = a || c, f = Se(t, e, d, i, o), m = Mt(f, i), d === a ? (t = f, a = m) : (e = f, c = m);
      }
    }
    ...
    function Nn(t, e, i) {
      ...
      for (d = 0; d < 4; d++) {
        for (w = o[d], n = [], a = 0, g = t.length, c = g - 1; a < g; c = a++)
          f = t[a], m = t[c], f._code & w ? m._code & w || (E = Se(m, f, w, e, i), E._code = Mt(E, e), n.push(E)) : (m._code & w && (E = Se(m, f, w, e, i), E._code = Mt(E, e), n.push(E)), n.push(f));
        t = n;
      }
      return t;
    }
    ...
    ft.Earth = bt, ft.EPSG3395 = kr, ft.EPSG3857 = oi, ft.EPSG900913 = $o, ft.EPSG4326 = Wn, ft.Simple = zr;
    var rt = Xt.extend({
    ...
    var ue = Dt.extend({
      ...
      _getIconUrl: function(t) {
        return typeof ue.imagePath != "string" && (ue.imagePath = this._detectIconPath()), (this.options.imagePath || ue.imagePath) + Dt.prototype._getIconUrl.call(this, t);
      },
      ...
      _detectIconPath: function() {
        var t = M("div", "leaflet-default-icon-path", document.body), e = ne(t, "background-image") || ne(t, "backgroundImage");
      ...
      removeHooks: function() {
        this._draggable.off({
          ...
          drag: this._onDrag,
          dragend: this._onDragEnd
        }, this).disable(), this._marker._icon && D(this._marker._icon, "leaflet-marker-draggable");
      },
      moved: function() {
        return this._draggable && this._draggable._moved;
      },
      _adjustPan: function(t) {
        var e = this._marker, i = e._map, n = this._marker.options.autoPanSpeed, o = this._marker.options.autoPanPadding, a = Ct(e._icon), c = i.getPixelBounds(), d = i.getPixelOrigin(), f = Y(
      ...
      _removeIcon: function() {
        this.options.riseOnHover && this.off({
          mouseover: this._bringToFront,
          mouseout: this._resetZIndex
        }), this.options.autoPanOnFocus && Z(this._icon, "focus", this._panOnFocus, this), $(this._icon), this.removeInteractiveTarget(this._icon), this._icon = null;
      },
      ...
      _initInteraction: function() {
        if (this.options.interactive && (A(this._icon, "leaflet-interactive"), this.addInteractiveTarget(this._icon), Un)) {
          var t = this.options.draggable;
          this.dragging && (t = this.dragging.enabled(), this.dragging.disable()), this.dragging = new Un(this), t && this.dragging.enable();
        }
      },
    ...
    var Mi = ke.extend({
      ...
      _project: function() {
        ...
        if (n.distance === bt.distance) {
          var o = Math.PI / 180, a = this._mRadius / bt.R / o, c = i.project([e + a, t]), d = i.project([e - a, t]), f = c.add(d).divideBy(2), m = i.unproject(f).lat, g = Math.acos((Math.cos(a * o) - Math.sin(e * o) * Math.sin(m * o)) / (Math.cos(e * o) * Math.cos(m * o))) / o;
        ...
        if (this._parts = [], !(!this._pxBounds || !this._pxBounds.intersects(t))) {
          ...
          for (i = 0, o = 0, a = this._rings.length; i < a; i++)
            for (f = this._rings[i], n = 0, c = f.length; n < c - 1; n++)
              d = Rn(f[n], f[n + 1], t, n, !0), d && (e[o] = e[o] || [], e[o].push(d[0]), (d[1] !== f[n + 1] || n === c - 2) && (e[o].push(d[1]), o++));
        }
      },
    ...
    var mt = pt.extend({
      ...
      addData: function(t) {
        ...
        if (a.filter && !a.filter(t))
          return this;
        var c = ze(t, a);
        return c ? (c.feature = Ze(t), c.defaultOptions = c.options, this.resetStyle(c), a.onEachFeature && a.onEachFeature(t, c), this.addLayer(c)) : this;
      },
    ...
    function ze(t, e) {
      var i = t.type === "Feature" ? t.geometry : t, n = i ? i.coordinates : null, o = [], a = e && e.pointToLayer, c = e && e.coordsToLatLng || ki, d, f, m, g;
      if (!n && !i)
        return null;
      switch (i.type) {
        case "Point":
          return d = c(n), Fn(a, t, d, e);
        case "MultiPoint":
          for (m = 0, g = n.length; m < g; m++)
            d = c(n[m]), o.push(Fn(a, t, d, e));
          return new pt(o);
        case "LineString":
        case "MultiLineString":
          return f = Oe(n, i.type === "LineString" ? 0 : 1, c), new _t(f, e);
        case "Polygon":
        case "MultiPolygon":
          return f = Oe(n, i.type === "Polygon" ? 1 : 2, c), new Nt(f, e);
    ...
    function Fn(t, e, i, n) {
      return t ? t(e, i) : new Me(i, n && n.markersInheritOptions && n);
    }
    function ki(t) {
    ...
    function Ie(t, e, i, n) {
      for (var o = [], a = 0, c = t.length; a < c; a++)
        o.push(e ? Ie(t[a], et(t[a]) ? 0 : e - 1, i, n) : zi(t[a], n));
      return !e && i && o.push(o[0].slice()), o;
    }
    function Ht(t, e) {
      return t.feature ? u({}, t.feature, { geometry: e }) : Ze(e);
    }
    function Ze(t) {
    ...
    Me.include(Oi), Mi.include(Oi), ke.include(Oi), _t.include({
      toGeoJSON: function(t) {
        var e = !et(this._latlngs), i = Ie(this._latlngs, e ? 1 : 0, !1, t);
        return Ht(this, {
      ...
      toGeoJSON: function(t) {
        var e = !et(this._latlngs), i = e && !et(this._latlngs[0]), n = Ie(this._latlngs, i ? 2 : e ? 1 : 0, !0, t);
    ...
    var Hr = Vn, Be = rt.extend({
      ...
      onRemove: function() {
        $(this._image), this.options.interactive && this.removeInteractiveTarget(this._image);
      },
      // @method setOpacity(opacity: Number): this
      ...
      _initImage: function() {
        var t = this._url.tagName === "IMG", e = this._image = t ? this._url : M("img");
      ...
      _initImage: function() {
        var t = this._url.tagName === "VIDEO", e = this._image = t ? this._url : M("video");
    ...
    var ct = rt.extend({
      ...
      onRemove: function(t) {
        t._fadeAnimated ? (tt(this._container, 0), this._removeTimeout = setTimeout(p($, void 0, this._container), 200)) : $(this._container), this.options.interactive && (D(this._container, "leaflet-interactive"), this.removeInteractiveTarget(this._container));
      },
    ...
    var Re = ct.extend({
      ...
      onAdd: function(t) {
        ct.prototype.onAdd.call(this, t), t.fire("popupopen", { popup: this }), this._source && (this._source.fire("popupopen", { popup: this }, !0), this._source instanceof xt || this._source.on("preclick", Et));
      },
      onRemove: function(t) {
        ct.prototype.onRemove.call(this, t), t.fire("popupclose", { popup: this }), this._source && (this._source.fire("popupclose", { popup: this }, !0), this._source instanceof xt || this._source.off("preclick", Et));
      },
      getEvents: function() {
      ...
      _initLayout: function() {
        var t = "leaflet-popup", e = this._container = M(
          "div",
          t + " " + (this.options.className || "") + " leaflet-zoom-animated"
        ), i = this._wrapper = M("div", t + "-content-wrapper", e);
        if (this._contentNode = M("div", t + "-content", i), ae(e), Pi(this._contentNode), T(e, "contextmenu", Et), this._tipContainer = M("div", t + "-tip-container", e), this._tip = M("div", t + "-tip", this._tipContainer), this.options.closeButton) {
          var n = this._closeButton = M("a", t + "-close-button", e);
      ...
      _updateLayout: function() {
        ...
        o && n > o ? (e.height = o + "px", A(t, a)) : D(t, a), this._containerWidth = this._container.offsetWidth;
      },
      _animateZoom: function(t) {
    ...
    var $e = ct.extend({
      ...
      _initLayout: function() {
        ...
        this._contentNode = this._container = M("div", e), this._container.setAttribute("role", "tooltip"), this._container.setAttribute("id", "leaflet-tooltip-" + v(this));
      },
      _updateLayout: function() {
      },
      _adjustPan: function() {
      ...
      _setPosition: function(t) {
        ...
        d === "top" ? (e = f / 2, i = m) : d === "bottom" ? (e = f / 2, i = 0) : d === "center" ? (e = f / 2, i = m / 2) : d === "right" ? (e = 0, i = m / 2) : d === "left" ? (e = f, i = m / 2) : c.x < a.x ? (d = "right", e = 0, i = m / 2) : (d = "left", e = f + (g.x + w.x) * 2, i = m / 2), t = t.subtract(x(e, i, !0)).add(g).add(w), D(o, "leaflet-tooltip-right"), D(o, "leaflet-tooltip-left"), D(o, "leaflet-tooltip-top"), D(o, "leaflet-tooltip-bottom"), A(o, "leaflet-tooltip-" + d), H(o, t);
      },
      _updatePosition: function() {
    ...
    S.include({
      ...
      bindTooltip: function(t, e) {
        return this._tooltip && this.isTooltipOpen() && this.unbindTooltip(), this._tooltip = this._initOverlay($e, this._tooltip, t, e), this._initTooltipInteractions(), this._tooltip.options.permanent && this._map && this._map.hasLayer(this) && this.openTooltip(), this;
      },
    ...
    var ce = rt.extend({
      ...
      onRemove: function(t) {
        this._removeAllTiles(), $(this._container), t._removeZoomLimit(this), this._container = null, this._tileZoom = void 0;
      },
      // @method bringToFront: this
      ...
      _initContainer: function() {
        this._container || (this._container = M("div", "leaflet-layer " + (this.options.className || "")), this._updateZIndex(), this.options.opacity < 1 && this._updateOpacity(), this.getPane().appendChild(this._container));
      },
      _updateLevels: function() {
        var t = this._tileZoom, e = this.options.maxZoom;
        if (t !== void 0) {
          for (var i in this._levels)
            i = Number(i), this._levels[i].el.children.length || i === t ? (this._levels[i].el.style.zIndex = e - Math.abs(t - i), this._onUpdateLevel(i)) : ($(this._levels[i].el), this._removeTilesAtZoom(i), this._onRemoveLevel(i), delete this._levels[i]);
          var n = this._levels[t], o = this._map;
          return n || (n = this._levels[t] = {}, n.el = M("div", "leaflet-tile-container leaflet-zoom-animated", this._container), n.el.style.zIndex = e, n.origin = o.project(o.unproject(o.getPixelOrigin()), t).round(), n.zoom = t, this._setZoomTransform(n, o.getCenter(), o.getZoom()), b(n.el.offsetWidth), this._onCreateLevel(n)), this._level = n, n;
        }
      },
      _onUpdateLevel: b,
      _onRemoveLevel: b,
      ...
      _invalidateAll: function() {
        for (var t in this._levels)
          $(this._levels[t].el), this._onRemoveLevel(Number(t)), delete this._levels[t];
            ...
            for (var w = o.min.y; w <= o.max.y; w++)
              for (var E = o.min.x; E <= o.max.x; E++) {
                ...
                if (it.z = this._tileZoom, !!this._isValidTile(it)) {
                  var kt = this._tiles[this._tileCoordsToKey(it)];
                  kt ? kt.current = !0 : c.push(it);
                }
              }
            if (c.sort(function(Pt, Ii) {
              return Pt.distanceTo(a) - Ii.distanceTo(a);
            }), c.length !== 0) {
              this._loading || (this._loading = !0, this.fire("loading"));
              var Ne = document.createDocumentFragment();
              for (E = 0; E < c.length; E++)
                this._addTile(c[E], Ne);
      ...
      _removeTile: function(t) {
        var e = this._tiles[t];
        e && ($(e.el), delete this._tiles[t], this.fire("tileunload", {
          tile: e.el,
      ...
      _tileReady: function(t, e, i) {
        ...
        i = this._tiles[n], i && (i.loaded = +new Date(), this._map._fadeAnimated ? (tt(i.el, 0), X(this._fadeFrame), this._fadeFrame = G(this._updateOpacity, this)) : (i.active = !0, this._pruneTiles()), e || (A(i.el, "leaflet-tile-loaded"), this.fire("tileload", {
          tile: i.el,
          coords: t
    ...
    var Wt = ce.extend({
      ...
      getTileUrl: function(t) {
        ...
        return Yi(this._url, u(e, this.options));
      },
      ...
      _abortLoading: function() {
        ...
        for (t in this._tiles)
          if (this._tiles[t].coords.z !== this._tileZoom && (e = this._tiles[t].el, e.onload = b, e.onerror = b, !e.complete)) {
            ...
            $(e), delete this._tiles[t], this.fire("tileabort", {
              tile: e,
              coords: i
            });
          }
      ...
      _removeTile: function(t) {
        var e = this._tiles[t];
        if (e)
          return e.el.setAttribute("src", we), ce.prototype._removeTile.call(this, t);
      },
      _tileReady: function(t, e, i) {
        if (!(!this._map || i && i.getAttribute("src") === we))
    ...
    var Kn = Wt.extend({
      ...
      getTileUrl: function(t) {
        var e = this._tileCoordsToNwSe(t), i = this._crs, n = Y(i.project(e[0]), i.project(e[1])), o = n.min, a = n.max, c = (this._wmsVersion >= 1.3 && this._crs === Wn ? [o.y, o.x, a.y, a.x] : [o.x, o.y, a.x, a.y]).join(","), d = Wt.prototype.getTileUrl.call(this, t);
        return d + Gi(this.wmsParams, d, this.options.uppercase) + (this.options.uppercase ? "&BBOX=" : "&bbox=") + c;
      },
    ...
    var gt = rt.extend({
      ...
      _updateTransform: function(t, e) {
        ...
        y.any3d ? At(this._container, a, i) : H(this._container, a);
      },
      _reset: function() {
      ...
      _destroyContainer: function() {
        X(this._redrawRequest), delete this._ctx, $(this._container), Z(this._container), delete this._container;
      },
      _updatePaths: function() {
      ...
      _handleMouseOut: function(t) {
        ...
        e && (D(this._container, "leaflet-interactive"), this._fireEvent([e], t, "mouseout"), this._hoveredLayer = null, this._mouseHoverThrottled = !1);
      },
    ...
    var de = function() {
      ...
      _initContainer: function() {
        this._container = M("div", "leaflet-vml-container");
      },
      _update: function() {
      ...
      _removePath: function(t) {
        var e = t._container;
        $(e), t.removeInteractiveTarget(e), delete this._layers[v(t)];
      },
      _updateStyle: function(t) {
    ...
    }, De = y.vml ? de : en, fe = gt.extend({
      _initContainer: function() {
        this._container = De("svg"), this._container.setAttribute("pointer-events", "none"), this._rootGroup = De("g"), this._container.appendChild(this._rootGroup);
      },
      _destroyContainer: function() {
        $(this._container), Z(this._container), delete this._container, delete this._rootGroup, delete this._svgSize;
      },
      _update: function() {
        if (!(this._map._animatingZoom && this._bounds)) {
          gt.prototype._update.call(this);
      ...
      _removePath: function(t) {
        $(t._path), t.removeInteractiveTarget(t._path), delete this._layers[v(t)];
      },
      _updatePath: function(t) {
    ...
    S.include({
      ...
      _createRenderer: function(t) {
        return this.options.preferCanvas && Qn(t) || Xn(t);
      }
    });
    var to = Nt.extend({
      initialize: function(t, e) {
    ...
    fe.create = De, fe.pointsToPath = nn, mt.geometryToLayer = ze, mt.coordsToLatLng = ki, mt.coordsToLatLngs = Oe, mt.latLngToCoords = zi, mt.latLngsToCoords = Ie, mt.getFeature = Ht, mt.asFeature = Ze, S.mergeOptions({
    ...
    var eo = ut.extend({
      ...
      _onMouseDown: function(t) {
        if (!t.shiftKey || t.which !== 1 && t.button !== 1)
          return !1;
        this._clearDeferredResetState(), this._resetState(), oe(), _i(), this._startPoint = this._map.mouseEventToContainerPoint(t), T(document, {
          contextmenu: St,
      ...
      _onMouseMove: function(t) {
        this._moved || (this._moved = !0, this._box = M("div", "leaflet-zoom-box", this._container), A(this._container, "leaflet-crosshair"), this._map.fire("boxzoomstart")), this._point = this._map.mouseEventToContainerPoint(t);
      ...
      _finish: function() {
        this._moved && ($(this._box), D(this._container, "leaflet-crosshair")), re(), mi(), Z(document, {
          contextmenu: St,
          mousemove: this._onMouseMove,
          mouseup: this._onMouseUp,
          keydown: this._onKeyDown
    ...
    S.addInitHook("addHandler", "boxZoom", eo), S.mergeOptions({
    ...
    S.addInitHook("addHandler", "doubleClickZoom", io), S.mergeOptions({
    ...
    var no = ut.extend({
      ...
      removeHooks: function() {
        D(this._map._container, "leaflet-grab"), D(this._map._container, "leaflet-touch-drag"), this._draggable.disable();
      },
      moved: function() {
        return this._draggable && this._draggable._moved;
      },
    ...
    S.addInitHook("addHandler", "dragging", no), S.mergeOptions({
      // @option keyboard: Boolean = true
    ...
    S.addInitHook("addHandler", "keyboard", oo), S.mergeOptions({
    ...
    var ro = ut.extend({
      ...
      _onWheelScroll: function(t) {
        ...
        clearTimeout(this._timer), this._timer = setTimeout(p(this._performZoom, this), n), St(t);
      },
    ...
    S.addInitHook("addHandler", "scrollWheelZoom", ro);
    var Qr = 600;
    S.mergeOptions({
    ...
    S.addInitHook("addHandler", "tapHold", so), S.mergeOptions({
      // @section Touch interaction options
    ...
    S.addInitHook("addHandler", "touchZoom", ao), S.BoxZoom = eo, S.DoubleClickZoom = io, S.Drag = no, S.Keyboard = oo, S.ScrollWheelZoom = ro, S.TapHold = so, S.TouchZoom = ao, s.Bounds = R, s.Browser = y, s.CRS = ft, s.Canvas = Jn, s.Circle = Mi, s.CircleMarker = ke, s.Class = dt, s.Control = ot, s.DivIcon = Gn, s.DivOverlay = ct, s.DomEvent = mr, s.DomUtil = pr, s.Draggable = wt, s.Evented = Xt, s.FeatureGroup = pt, s.GeoJSON = mt, s.GridLayer = ce, s.Handler = ut, s.Icon = Dt, s.ImageOverlay = Be, s.LatLng = O, s.LatLngBounds = K, s.Layer = rt, s.LayerGroup = $t, s.LineUtil = Er, s.Map = S, s.Marker = Me, s.Mixin = Pr, s.Path = xt, s.Point = P, s.PolyUtil = Sr, s.Polygon = Nt, s.Polyline = _t, s.Popup = Re, s.PosAnimation = Mn, s.Projection = Mr, s.Rectangle = to, s.Renderer = gt, s.SVG = fe, s.SVGOverlay = jn, s.TileLayer = Wt, s.Tooltip = $e, s.Transformation = ni, s.Util = Bo, s.VideoOverlay = qn, s.bind = p, s.bounds = Y, s.canvas = Qn, s.circle = $r, s.circleMarker = Rr, s.control = le, s.divIcon = jr, s.extend = u, s.featureGroup = Ir, s.geoJSON = Vn, s.geoJson = Hr, s.gridLayer = Gr, s.icon = Zr, s.imageOverlay = Wr, s.latLng = I, s.latLngBounds = F, s.layerGroup = Or, s.map = gr, s.marker = Br, s.point = x, s.polygon = Nr, s.polyline = Dr, s.popup = Vr, s.rectangle = Jr, s.setOptions = z, s.stamp = v, s.svg = Xn, s.svgOverlay = Fr, s.tileLayer = Yn, s.tooltip = qr, s.transformation = te, s.version = h, s.videoOverlay = Ur;
    var Xr = window.L;
...
async function Zs(l, r) {
  const s = await import(
    /* @vite-ignore */
    r
  ), h = s == null ? void 0 : s.default, u = Vi.size, _ = `gwf-vis-plugin-${Bs(l)}-${u}`;
  Rs(_, h) && Vi.set(l, _);
}
function Bs(l = "") {
...
let Yt = class extends at {
  ...
  render() {
    return Fi(
      ...
      () => {
        var l, r;
        return st`
        <div id="map" ${To(this.mapElementRef)}></div>
        <div
          id="invisible-plugin-container"
          hidden
          ${To(this.hiddenPluginContainerRef)}
        ></div>
        <div
  ...
  async initializeVis() {
    !this.map && this.mapElementRef.value && (this.initializeMap(this.mapElementRef.value), this.initializeSidebar(), await this.importPlugins(), this.loadPlugins(), this.loadingActive = !1, this.applyToPlugins(
      (l) => {
        var r;
        return (r = l.hostFirstLoadedCallback) == null ? void 0 : r.call(l);
      }
    ));
  }
  initializeMap(l) {
  ...
  initializeSidebar() {
    ...
    const l = vt.Control.extend({
      onAdd: () => (this.sidebarElement = vt.DomUtil.create(
  ...
  initializeLayerControl() {
    var l, r;
    (l = this.layerControl) == null || l.remove(), this.layerControl = vt.control.layers(), (r = this.map) == null || r.addControl(this.layerControl);
  }
  loadPlugins() {
    var l;
    try {
  ...
  updateLoadingStatus() {
    this.pluginLoadingPool.some((l) => l) ? this.loadingActive = !0 : this.loadingActive = !1;
  }
  applyToPlugins(l) {
  ...
  presentPluginInLargeView(l) {
    this.pluginLargePresenterContentInfo || (this.pluginLargePresenterContentInfo = {
  ...
  dismissPluginLargePresenter() {
    var l, r, s;
    (s = (l = this.pluginLargePresenterContentInfo) == null ? void 0 : l.originalContainer) == null || s.replaceChildren(
      ((r = this.pluginLargePresenterContentInfo) == null ? void 0 : r.pluginInstance) ?? ""
    ), this.pluginLargePresenterContentInfo = void 0;
  }
};
Yt.styles = [Tt([Ds]), Tt([$s])];
Ye([
  ko()
], Yt.prototype, "loadingActive", 2);
Ye([
  ko()
], Yt.prototype, "pluginLargePresenterContentInfo", 2);
Ye([
  U()
...
qe = Oo([
  Ot("gwf-vis-host-sidebar")
], qe);
const Vs = `:host{display:block}:host([slot="top"]){margin:var(--leaflet-control-margin)}[part=header]{font-size:1.2rem;font-weight:700;user-select:none}[part=content]{background:var(--leaflet-control-inner-background);border:var(--leaflet-control-border);border-radius:var(--leaflet-control-border-radius);box-shadow:var(--leaflet-control-box-shadow);max-width:100%;overflow:hidden;padding:var(--leaflet-control-padding)}gwf-vis-ui-collapse::part(header){margin:0 var(--leaflet-control-margin)}gwf-vis-ui-collapse::part(content){margin:var(--leaflet-control-margin)}#show-in-large-view-button{font-size:1.2rem;appearance:none;border:none;outline:none;background:none;cursor:pointer}#show-in-large-view-button:hover{transform:scale(1.2)}#show-in-large-view-button:active{transform:scale(.9)}
`;
var qs = Object.defineProperty, js = Object.getOwnPropertyDescriptor, Ke = (l, r, s, h) => {
  for (var u = h > 1 ? void 0 : h ? js(r, s) : r, _ = l.length - 1, p; _ >= 0; _--)
    (p = l[_]) && (u = (h ? p(r, s, u) : p(u)) || u);
  return h && u && qs(r, s, u), u;
};
let Kt = class extends at {
  ...
  render() {
    var l;
    return ((l = this.containerProps) == null ? void 0 : l.slot) === "top" ? this.renderContent() : st`
...
Jt = Je([
  Ot("gwf-vis-host-main-item-container")
], Jt);
/**
 * @license
...
let Qt = class extends at {
  ...
  render() {
    return st`
      ${Fi(this.href, () => this.renderHrefHandler())}
      <div id="container">
        <slot></slot>
      </div>
    `;
  ...
  renderHrefHandler() {
    return st` <a id="href-handler" href=${_e(this.href)}></a> `;
  }
};
Qt.styles = [Tt([Js])];
Qe([
...
Qt = Qe([
  Ot("gwf-vis-ui-button")
], Qt);
const ta = `:host{display:block}[part=content-container]{box-sizing:border-box;overflow:hidden;max-height:100vh;transition:max-height .3s}#collapse-toggle:checked~[part=content-container]{max-height:0}[part=header-container]{display:block;cursor:pointer;transition:transform .3s}[part=header-container]:hover{backdrop-filter:contrast(.7)}[part=header-container]:active{backdrop-filter:contrast(.5)}[part=header]:before{content:"";display:inline-block;border-top:5px solid transparent;border-bottom:5px solid transparent;border-left:5px solid currentColor;vertical-align:middle;margin:0 .7rem 0 .25rem;transform:translateY(-50%) rotate(90deg);transition:transform .3s}#collapse-toggle:checked~[part=header-container]>[part=header]:before{transform:translateY(-50%)}::slotted([slot="header"]){display:inline-block}
`;
var ea = Object.defineProperty, ia = Object.getOwnPropertyDescriptor, Io = (l, r, s, h) => {
  for (var u = h > 1 ? void 0 : h ? ia(r, s) : r, _ = l.length - 1, p; _ >= 0; _--)
    (p = l[_]) && (u = (h ? p(r, s, u) : p(u)) || u);
  return h && u && ea(r, s, u), u;
};
...
export {
  Yt as GWFVisHost,
  Jt as GWFVisHostMainItemContainer,
  qe as GWFVisHostSidebar,
  Kt as GWFVisHostSidebarItemContainer,
  Qt as GWFVisUIButton,
  je as GWFVisUICollapse,
  yt as GWFVisUIInput
};
